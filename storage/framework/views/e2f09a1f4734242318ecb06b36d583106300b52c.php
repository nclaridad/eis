...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/uniform.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/select2.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/unicorn.main.css')); ?>" />
    ...
    <div id="user-nav" class="navbar navbar-inverse">
        <ul class="nav btn-group">
            ...
            <li class="btn btn-inverse">
                <a title="" href="<?php echo e(url('/logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
