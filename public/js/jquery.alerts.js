		...
		_show: function(title, msg, value, type, callback) {
			...
			switch (type) {
				...
				case 'prompt':
					...
					$("#popup_message").append('<br /><textarea id="remarks" placeholder="Remarks" style="width:100%;"></textarea>').after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" id="popup_ok" /> <input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" /></div>');
			...
			switch( status ) {
				case 'show':
					...
					$("#popup_overlay").css({
						...
						background: 'url("<?php echo base_url("images/ui-bg_flat_0_aaaaaa_40x100.png") ?>") repeat-x scroll 50% 50% #AAAAAA',
						opacity: '0.3'
					});
				break;
				case 'hide':
