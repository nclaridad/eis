...
<head>
    ...
    <script src="{{URL::asset('js/jquery-ui.custom.min.js')}}"></script>
    <!-- Scripts -->
    <script>
...
<body>
    ...
    <div id="sidebar">
        ...
        <ul>
            <li class="active" ><a href="{{ url('/employees') }}">
    ...
    <!--script src="{{URL::asset('js/datatables/dataTables.colVis.min.js')}}"></script>
    <script src="{{URL::asset('js/datatables/dataTables.tableTools.min.js')}}"></script>
    <script src="{{URL::asset('js/datatables/dataTables.bootstrap.min.js')}}"></script>
    <script src="{{URL::asset('js/datatable-responsive/datatables.responsive.min.js')}}"></script -->          
</body>
</html>
